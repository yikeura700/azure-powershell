@{
  ...
  FunctionsToExport = 'Enable-AzActionGroupReceiver', 'Get-AzActionGroup', 'Get-AzActionGroupTestNotification', 'New-AzActionGroup', 'New-AzActionGroupNotification', 'Remove-AzActionGroup', 'Set-AzActionGroup', 'Update-AzActionGroup'
  PrivateData = @{
    PSData = @{
