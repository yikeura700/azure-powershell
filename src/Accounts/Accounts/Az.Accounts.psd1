...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Supported Web Account Manager (WAM) as the default interactive login experience. Note that Microsoft account (MSA) type is not supported.
